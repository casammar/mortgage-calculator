...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Calculation') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif -->
                    <form method="POST" action="{{ route('calculation.update', $calculation->id) }}">
                        @method('PATCH') 
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="loan-value" type="text" class="form-control @error('loan_value') is-invalid @enderror" name="loan_value" value="{{ $calculation->loan_value }}"  required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="years" type="text" class="form-control @error('years') is-invalid @enderror" name="years" value="{{ $calculation->years }}"  required autocomplete="years" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="interest_rate" type="text" class="form-control @error('interest_rate') is-invalid @enderror" name="interest_rate" value="{{ $calculation->interest_rate }}"  required autocomplete="interest_rate" autofocus>
